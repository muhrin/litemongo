...
class CollectionAPITest(TestCase):
    ...
    def setUp(self):
        ...
        self.tempfile.close()
        self.client = litemongo.MongoClient(self.tempfile.name, 'w', store_type='pytables')
    ...
    @unittest.skip("Haven't figured out how to force pytables to track order of creations which "
